    ...
    <>
      <div className="container about">
        <div className="text-zone">
          <h1>About me!</h1>
          <h3>My name is <span style={{color:'white', fontWidth:'900px  '}}>Omkaar Shenoy</span> and I am a <span style={{color:'white', fontWidth:'900px  '}}>computer science</span> student at Arizona State University with a minor in <span style={{color:'white', fontWidth:'900px  '}}>Statistics</span>. My focus is on <span style={{color:'white', fontWidth:'900px  '}}>software engineering, data analysis, and machine learning</span>, and I have also participated in various outside-of-class projects and organizations. I am <span style={{color:'white', fontWidth:'900px  '}}>passionate about creating innovative solutions</span> that make a positive impact on society and am always looking for new opportunities to grow and learn.  
